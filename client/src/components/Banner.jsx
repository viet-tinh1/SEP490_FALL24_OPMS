  ...
  return (
    ...
    <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
      <div className="text-center md:text-left space-y-6 lg:max-w-[400px]:">
        ...
        <p className="text-gray-400">Healthy and yummy food for fresh morning breakfast.
         Eat Daily for good health and mind Order now and get 20% off on your first order</p>
         {/*button section*/}
     ...
     <div className="flex justify-center items-center">
      <img src={Imgtree} alt="Imgtree" className="w-[350px] md:w-[550px] drop-shadow"/>
     </div>
       {/*leaf image*/}
       <div className="absolute top-14 md:top-0 right-1/2 blur-sm opacity-80 rotate-[40deg]">
      <img src={Imgleaf} alt="Imgtree" className="w-full md:max-w-[300px]"/>
     </div>
    </div>
